...
No AI agent may bypass risk controls; no AI agent may directly modify production trading logic; learning always flows through the full validation pipeline (Section 12); nothing self-modifies production strategies automatically.
